package com.jetpack.roomdbmanytomanyrelationship
...
import com.jetpack.roomdbmanytomanyrelationship.ui.theme.LightGray100
import com.jetpack.roomdbmanytomanyrelationship.ui.theme.Purple500
import com.jetpack.roomdbmanytomanyrelationship.ui.theme.RoomDbManyToManyRelationshipTheme
import com.jetpack.roomdbmanytomanyrelationship.viewmodel.UserViewModel
import com.jetpack.roomdbmanytomanyrelationship.viewmodel.UserViewModelFactory
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            RoomDbManyToManyRelationshipTheme {
    ...
    Scaffold {
        Column(
            ...
            Column(
                ...
                Text(text = "Many To Many Relationship", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 20.sp)
            }
            Column(
                modifier = Modifier
                    .fillMaxWidth()
